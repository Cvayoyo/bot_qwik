...
for i in {1..4}; do
  ...
  gcloud compute instances create \"\$name\" \\
    ...
    --create-disk=auto-delete=yes,boot=yes,image=projects/ubuntu-os-cloud/global/images/ubuntu-minimal-2404-noble-amd64-v20250606,mode=rw,size=10,type=pd-balanced \\
