...
--metadata=startup-script='sudo apt update -y && sudo apt install git -y &&  sudo apt install screen -y && git clone https://github.com/RizqiKamall/minme1 && cd minme1 && sudo chmod +x * && sudo ./install.sh'
