...
gcloud compute instances create instance-$acc1 instance-$acc2 instance-$acc3 instance-$acc4 --project=$project_ids --zone=$ZONE --machine-type=e2-custom-6-3072 --metadata=startup-script=sudo\ \
